module.exports = native => {
  const ctx = {
    ...
    BlockUpdate: (value) => {
      ...
      size += (undefined)(transition_type)
      return size
    },
    TransitionType: (value) => {
      return (undefined)({"entity":0,"create":1,"destroy":2}[value] || value)
    },
    ...
    mcpe_packet: (value) => {
      ...
      size += ((value) => {
        switch (name) {
          ...
          case "photo_info_request_packet": return (ctx.packet_photo_info_request_packet)(value)
          default: return (ctx.void)(value)
        }
      })(params)
      return size
    ...
    packet_adventure_settings: (value) => {
      ...
      let command_permission = value.command_permission
      size += ((value) => {
        return (ctx.varint)({"normal":0,"operator":1,"host":2,"automation":3,"admin":4}[value] || value)
      })(command_permission)
      let action_permissions = value.action_permissions
    ...
    packet_npc_request: (value) => {
      ...
      let action_type = value.action_type
      size += ((value) => {
        return (ctx.u8)({"set_actions":0,"execute_action":1,"execute_closing_commands":2,"set_name":3,"set_skin":4,"set_interact_text":5,"execute_openining_commands":6}[value] || value)
      })(action_type)
    ...
    packet_photo_transfer: (value) => {
      ...
      size += (ctx.i64)(owner_entity_unique_id)
    ...
    packet_animate_entity: (value) => {
      ...
      size += (ctx.li64)(stop_condition_version)
    ...
    packet_photo_info_request_packet: (value) => {
      let size = 0
