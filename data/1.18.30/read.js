module.exports = native => {
  const ctx = {
    ...
    Skin: (buffer, offset) => {
      ...
      return { value: { skin_id, play_fab_id, skin_resource_pack, skin_data, animations, cape_data, geometry_data, geometry_data_version, animation_data, cape_id, full_skin_id, arm_size, skin_color, personal_pieces, piece_tint_colors, premium, persona, cape_on_classic, primary_user }, size: skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + geometry_data_versionSize + animation_dataSize + cape_idSize + full_skin_idSize + arm_sizeSize + skin_colorSize + personal_piecesSize + piece_tint_colorsSize + premiumSize + personaSize + cape_on_classicSize + primary_userSize}
    },
    ...
    StructureBlockSettings: (buffer, offset) => {
      ...
      })(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize)
      let { value: mirror, size: mirrorSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"0":"none","1":"x_axis","2":"z_axis","3":"both_axes"}[value] || value, size }
      })(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize)
      let { value: animation_mode, size: animation_modeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"0":"none","1":"layers","2":"blocks"}[value] || value, size }
      })(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize)
      let { value: animation_duration, size: animation_durationSize } = (ctx.lf32)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + animation_modeSize)
      let { value: integrity, size: integritySize } = (ctx.lf32)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + animation_modeSize + animation_durationSize)
      let { value: seed, size: seedSize } = (ctx.lu32)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + animation_modeSize + animation_durationSize + integritySize)
      let { value: pivot, size: pivotSize } = (ctx.vec3f)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + animation_modeSize + animation_durationSize + integritySize + seedSize)
      return { value: { palette_name, ignore_entities, ignore_blocks, size: size1, structure_offset, last_editing_player_unique_id, rotation, mirror, animation_mode, animation_duration, integrity, seed, pivot }, size: palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + animation_modeSize + animation_durationSize + integritySize + seedSize + pivotSize}
    },
    ...
    BlockUpdate: (buffer, offset) => {
      ...
      let { value: transition_type, size: transition_typeSize } = (undefined)(buffer, offset + positionSize + runtime_idSize + flagsSize + entity_unique_idSize)
    ...
    TransitionType: (buffer, offset) => {
      const { value, size } = (undefined)(buffer, offset)
      return { value: {"0":"entity","1":"create","2":"destroy"}[value] || value, size }
    },
    MaterialReducer: (buffer, offset) => {
      let { value: mix, size: mixSize } = (ctx.varint)(buffer, offset)
      let { value: items, size: itemsSize } = ((buffer, offset) => {
        let { value: network_id1, size: network_id1Size } = (ctx.varint)(buffer, offset)
        let { value: count1, size: count1Size } = (ctx.varint)(buffer, offset + network_id1Size)
    ...
    mcpe_packet: (buffer, offset) => {
      ...
      let { value: params, size: paramsSize } = ((buffer, offset) => {
        switch (name) {
          ...
          case "photo_info_request_packet": return (ctx.packet_photo_info_request_packet)(buffer, offset)
          default: return (ctx.void)(buffer, offset)
        }
    ...
    packet_crafting_data: (buffer, offset) => {
      ...
      let { value: material_reducers, size: material_reducersSize } = ((buffer, offset) => {
        ...
        return { value: data, size }
      })(buffer, offset + recipesSize + potion_type_recipesSize)
      let { value: potion_container_recipes, size: potion_container_recipesSize } = (ctx.PotionContainerChangeRecipes)(buffer, offset + recipesSize + potion_type_recipesSize + material_reducersSize)
      let { value: clear_recipes, size: clear_recipesSize } = (ctx.bool)(buffer, offset + recipesSize + potion_type_recipesSize + material_reducersSize + potion_container_recipesSize)
      return { value: { recipes, potion_type_recipes, material_reducers, potion_container_recipes, clear_recipes }, size: recipesSize + potion_type_recipesSize + material_reducersSize + potion_container_recipesSize + clear_recipesSize}
    },
    ...
    packet_event: (buffer, offset) => {
      ...
      let { value: event_type, size: event_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.zigzag32)(buffer, offset)
        return { value: {"0":"achievement_awarded","1":"entity_interact","2":"portal_built","3":"portal_used","4":"mob_killed","5":"cauldron_used","6":"player_death","7":"boss_killed","8":"agent_command","9":"agent_created","10":"banner_pattern_removed","11":"commaned_executed","12":"fish_bucketed","13":"mob_born","14":"pet_died","15":"cauldron_block_used","16":"composter_block_used","17":"bell_block_used","18":"actor_definition","19":"raid_update","20":"player_movement_anomaly","21":"player_moement_corrected","22":"honey_harvested","23":"target_block_hit","24":"piglin_barter","25":"waxed_or_unwaxed_copper"}[value] || value, size }
    ...
    packet_npc_request: (buffer, offset) => {
      ...
      let { value: action_type, size: action_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"0":"set_actions","1":"execute_action","2":"execute_closing_commands","3":"set_name","4":"set_skin","5":"set_interact_text","6":"execute_openining_commands"}[value] || value, size }
    ...
    packet_photo_transfer: (buffer, offset) => {
      ...
      let { value: owner_entity_unique_id, size: owner_entity_unique_idSize } = (ctx.i64)(buffer, offset + image_nameSize + image_dataSize + book_idSize + photo_typeSize + source_typeSize)
    ...
    packet_update_block_synced: (buffer, offset) => {
      ...
      let { value: transition_type, size: transition_typeSize } = (undefined)(buffer, offset + positionSize + block_runtime_idSize + flagsSize + layerSize + entity_unique_idSize)
    ...
    packet_animate_entity: (buffer, offset) => {
      ...
      let { value: stop_condition_version, size: stop_condition_versionSize } = (ctx.li64)(buffer, offset + animationSize + next_stateSize + stop_conditionSize)
    ...
    packet_add_volume_entity: (buffer, offset) => {
      ...
      let { value: nbt, size: nbtSize } = (ctx.nbt)(buffer, offset + entity_idSize)
      let { value: engine_version, size: engine_versionSize } = (ctx.string)(buffer, offset + entity_idSize + nbtSize)
      return { value: { entity_id, nbt, engine_version }, size: entity_idSize + nbtSize + engine_versionSize}
    },
    ...
    packet_create_photo: (buffer, offset) => {
      let { value: entity_unique_id, size: entity_unique_idSize } = (ctx.i64)(buffer, offset)
    ...
    packet_photo_info_request_packet: (buffer, offset) => {
    ...
    CommandFlags: (buffer, offset) => {
      ...
      return { value: { unused, collapse_enum, has_semantic_constraint, as_chained_command }, size: 1 }
    },
